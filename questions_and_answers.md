...
<i>There's a misspelling in the code – it should be "let greeting" but it says
...
<i>Even though we changed info.favoriteFood to "🍝", the original list of foods
(food) stays the same. So, when we check what's in food, it still has ['🍕',
'🍫', '🥑', '🍔'].</i>
